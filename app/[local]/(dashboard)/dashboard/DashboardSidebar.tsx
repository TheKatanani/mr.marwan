...
const dashboardLinks = [
  ...
  { href: '/dashboard/courses', label: 'الدورات التدريبية' },
  ...
  { href: '/dashboard/partners', label: 'شركاء' },
  { href: '/dashboard/contact', label: 'التواصل' },
  { href: '/dashboard/book', label: 'مستخدمين الكتاب' },
  { href: '/dashboard/facilities', label: 'مرفقاتنا' },
  { href: '/dashboard/reviews', label: 'الاراء' },
  ...
  return (
    <>
      ...
      <aside
        ...
        } min-h-screen fixed md:static top-16 left-0 md:top-0 w-full md:w-64 bg-white border-l border-gray-200 shadow-md p-6 space-y-6 z-30 md:block h-screen overflow-auto`}
      >
