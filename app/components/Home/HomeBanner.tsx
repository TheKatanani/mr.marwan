...
export default async function HomeBanner() {
  ...
  return (
    <section
      className="relative bg-cover bg-gradient-to-l from-[#1E40AF] via-[#3B82F6] to-[#60A5FA] text-white"
    > 
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex-1 text-center md:text-right">
          <h1 className="text-xl md:text-3xl font-bold mb-6 leading-tight text-white">
            {bannerData?.title}
          </h1>
